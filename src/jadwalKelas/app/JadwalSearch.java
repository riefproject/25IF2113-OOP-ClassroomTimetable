...
import jadwalKelas.model.Jadwal;
import jadwalKelas.model.Kelas;
...
public final class JadwalSearch {
    ...
    public static void searchByKelas(DataSeeder.Seed seed, String kodeKelas, String hariArg) {
        ...
        System.out.printf("%-10s | %-25s | %-30s | %-13s | %-15s%n",
                "Hari", "Matkul", "Dosen", "Waktu", "Ruang");
        System.out.println("------------------------------------------------------------------------------------------");

        // Body
        source.stream()
                .sorted(Comparator.comparing(Jadwal::getHari)
    ...
    private static DayOfWeek parseHari(String s) {
        ...
        switch (x) {
            ...
            case "jumat":
            case "jum'at":  return DayOfWeek.FRIDAY;
            case "sabtu":   return DayOfWeek.SATURDAY;
            case "minggu":
            case "ahad":    return DayOfWeek.SUNDAY;
        }
        try {
